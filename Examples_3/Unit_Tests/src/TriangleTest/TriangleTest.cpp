...
class TriangleTest : public IApp {
public:
    bool Init()
    {
        // FILE PATHS
    ...
    void addShaders()
    {
        ...
        basicShader.mStages[0].pFileName = "triangle.vert";
        basicShader.mStages[1].pFileName = "triangle.frag";
...
DEFINE_APPLICATION_MAIN(TriangleTest)